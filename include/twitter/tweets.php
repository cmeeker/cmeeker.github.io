...
if( isset( $_GET['username'] ) AND $_GET['username'] != '' ):
    ...
    $consumerkey = "tiA4TgOXWeAOz9k173KPxmg73";
	$consumersecret = "uOgS7UZRyEut2RSJsjLWFkTZTJMgazCET3Iqp1Mm2kGqLDX1nF";
    $accesstoken = "3065275555-jeUvUz1a0UOzIFwe0Bw2tJEPybxfP4Ne3DbSD2E";
    $accesstokensecret = "ayshUZ7V7nLqPCc3yJh0sm5vLEcTJncktkXNH3MyGp0rZ";
